...
- 'raspberry pi'
- 'research'
twitter_text: Checkout the Niryo Ned
...
- The whole ROS architecture has been redesigned (see diagram below) in order to make Ned more **adaptative**, and suitable for a huge application range.
